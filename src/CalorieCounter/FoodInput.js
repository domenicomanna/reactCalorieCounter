...
export default function FoodInput() {
    return (
        <ul className="list calorie-counter__group calorie-counter__inputs">
            ...
            <li><input type="text" className="calorie-counter__food-input" placeholder="Calories" /></li>
            <li><input type="text" className="calorie-counter__food-input" placeholder="Fat" /></li>
